...
<head>
        <title>Md. Humayun Farid - Bangladeshi Bangladeshi Entrepreneur, Musical artist, Digital Marketer, and Social media cyber security specialist. </title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta name="description" content="Md. Humayun Farid and personal website." />
        ...
        <meta name="developer" content="Md. Humayun Farid">
                    ...
                    <div class="row section-separator xs-column-reverse vertical-middle-content home-padding">
                        <div class="col-sm-6">
                            <div class="mh-header-info">
                                ...
                                <h2 class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s"><?php echo isset($user) ? ucwords($user['firstname'].' '.$user['lastname']) : ""; ?></h2>
                                <h4 class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s"><?php echo isset($user) ? ucwords($user['possession']) : ""; ?></h4>
                                
                                <ul>
                                    <li class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s"><i class="fa fa-envelope"></i><a href="mailto:"><?php echo $contact['email'] ?></a></li>
                                    <li class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.5s"><i class="fa fa-phone"></i><a href="callto:"><?php echo $contact['mobile'] ?></a></li>
                                    <li class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s"><i class="fa fa-map-marker"></i><address><?php echo $contact['address'] ?></address></li>
                                </ul>
                                ...
                                <ul class="social-icon wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.7s">
                                    ...
                                    <li><a href="<?php echo $contact['linkin'] ?>"><i class="fa fa-github"></i></a></li>
                        ...
                        <div class="col-sm-6">
                            <div class="hero-img wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s">
                                <div class="img-border">
                                    <img src="<?php echo validate_image($_settings->userdata('avatar')) ?>" alt="User Image"  class="img-fluid">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row section-separator">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="mh-about-inner">
                            ...
                            <p class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s"><?php include "about.html"; ?></p>
  ...
  <?php endwhile; ?>
                    ...
                    <!-- <div class="col-sm-4">
                        <div class="mh-service-item shadow-1 dark-bg wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.5s">
                            ...
                            <p>
                                A WordPress developer is a professional who works with the basic coding and infrastructure of the WordPress platform, 
                                to improve WordPress itself, or to create entirely new products. 
                    ...
                    <!-- <div class="col-sm-4">
                        <div class="mh-service-item shadow-1 dark-bg wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.7s">
                            ...
                            <p>
                                App Development refers to the creation of computer applications for use on mobile devices such as tablets, 
                                    ...
                                    <div class="row">
                                        <div class="col-sm-7">
                                            <div class="mh-featured-project-img shadow-2 wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">
                                                <img src="<?php echo validate_image($row['banner']) ?>" alt="" class="img-fluid">
                                            </div>
                                        </div>
                                        <div class="col-sm-5">
                                        ...
                                        <div class="candidatos">
                                            <div class="parcial">
                                                <div class="info">
                                                    ...
                                                    <div class="percentagem-num">56%</div>
                                                </div>
        ...
        <section class="mh-experince image-bg featured-img-one" id="mh-experience">
          ...
          ?>
                                    <div class="mh-education-item dark-bg wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s">
                                        <h4><?php echo $row['degree'] ?>
                                        <a href="https://daffodilvarsity.edu.bd"> </br><?php echo $row['school'] ?></a></h4>
                                        <div class="mh-eduyear"><em class="date"><?php echo $row['month'].' '.$row['year'] ?></em></div>
          ...
          ?>
                                    <div class="mh-work-item dark-bg wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s">
                                        <h4><?php echo $row['position'] ?>  <a href="https://stitbd.com"><?php echo $row['company'] ?></a></h4>
                                        <div class="mh-eduyear"><em class="date"><?php echo str_replace("_"," ",$row['started']) ?> - <?php echo str_replace("_"," ",$row['ended']) ?></em></div>
                                ...
                                <div class="col-sm-12 col-md-6 mh-footer-address">
                                    ...
                                    <div class="col-sm-12 xs-no-padding">
                                        <div class="mh-address-footer-item media dark-bg shadow-1 wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s">
                                            ...
                                            <div class="each-info media-body">
                                                <h4>Phone</h4>
                                                <a href="callto:<?php echo $contact['mobile'] ?>"><?php echo $contact['mobile'] ?></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="text-left text-xs-center">
                                                <p><a href="humayun.xyz">© 2021 All Rights Reserved. Design & Developed By Humayun</a></p>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <ul class="social-icon">
                                                <li><a href="<?php echo $contact['facebook'] ?>"><i class="fa fa-facebook"></i></a></li>
                                                <li><a href="<?php echo $contact['twitter'] ?>"><i class="fa fa-twitter"></i></a></li>
                                                <li><a href="https://github.com/HumayunBee"><i class="fa fa-github"></i></a></li>
                                                <li><a href="#"><i class="fa fa-dribbble"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
